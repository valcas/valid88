...
function (_BaseValidator) {
  ...
  function MandatoryValidator(register) {
    _classCallCheck(this, MandatoryValidator);

    return _possibleConstructorReturn(this, _getPrototypeOf(MandatoryValidator).call(this, register, 'mandatory'));
  }
...
exports["default"] = MandatoryValidator;